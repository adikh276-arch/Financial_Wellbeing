...
export default function InvestingBasics() {
  ...
  return (
    <LearnModule
      ...
      introduction={t("Investing is not complex. Itt(")}s simply putting your money to work so it grows while you sleep. Start simple, understand the basics, and let compound returns work for you.")
      sections={[
        { 
          icon: TrendingUp, 
          heading: t("Asset Classes Explained"), 
          content: [
            { title: 'Stocks', description: t("Ownership in companies. Highest growth potential (12-18% avg) but highest short-term volatility.") }, 
            ...
            { title: 'Gold', description: t("Safe haven asset, hedge against inflation. No income generation but stores value over decades.") }
          ], 
          variant: 'cards' 
        },
        { 
        ...
        { 
          ...
          content: 'Invest a fixed amount monthly regardless of market price. You buy more units when the market is low, fewer when high - this automatically averages your cost and removes timing risk. Investing a fixed amount monthly for just 5 years eliminates the stress of t("when to invest.")' 
        },
        { 
          icon: Sparkles, 
