    ...
    <LearnModule
      ...
      sections={[
        { 
          ...
          content: [
            { title: '50% - Needs', description: t("Housing, utilities, groceries, transport, insurance, minimum debt payments. Cannot live without these.") }, 
            { title: '30% - Wants', description: t("Entertainment, hobbies, dining out, shopping, subscriptions, travel. Enrich life but aren\\")t survival.' }, 
            { title: '20% - Savings & Debt', description: t("Emergency fund, investments, extra debt payments, retirement savings. Your future security.") }
          ] 
        },
        { 
          icon: Repeat, 
        ...
        { 
          ...
          content: [
            t("Income 1,000: Needs 500 | Wants 300 | Savings 200"), 
            t("Income 2,000: Needs 1,000 | Wants 600 | Savings 400"), 
            t("Income 5,000: Needs 2,500 | Wants 1,500 | Savings 1,000")
          ] 
        },
        { 
          icon: Lightbulb, 
