...
export default function EmergencyFundLearn() {
  ...
  return (
    <LearnModule
      ...
      readTime="5 min"
      category="Savings"
      introduction={t("An emergency fund is not optional")}itt("s essential. It")s the difference between a problem and a catastrophe. Think of it as your financial airbag."
      sections={[
        { 
          icon: Shield, 
      ...
      actionSteps={[
        ...
        { number: '04', text: 'Open a separate savings account labeled t("Emergency Fund - Do Not Touch")' }, 
