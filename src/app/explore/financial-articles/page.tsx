  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-base)' }}>
      <div className="topbar">
        ...
        <div>
          <h1 className="heading-md">Knowledge Center</h1>
        </div>
      </div>

      <div className="page-wrapper">
        <div style={{ marginBottom: 'var(--space-8)' }}>
          <h2 className="display-sm" style={{ marginBottom: 4 }}>Institutional Insights</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: 14 }}>Global perspective on wealth management and behavior.</p>
        </div>
