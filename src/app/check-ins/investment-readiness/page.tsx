...
const QUESTIONS = [
  ...
  { id: 'risk', text: t('If your portfolio dropped 20% in a month, you would:'), options:[t('Sell immediately to avoid further loss'), t('Worry significantly'), t('Stay the course'), t('View it as a buying opportunity')] },
];
