...
export default function MindfulSpending() {
  ...
  return (
    <LearnModule
      ...
      readTime="6 min"
      category="Behavior"
      introduction={t("Mindful spending is not about spending less. Itt(")}s about spending intentionally. Buying what aligns with your values, not what impulse drives you to buy.")
      sections={[
        { 
          icon: Brain, 
        ...
        { 
          ...
          content: [
            { title: 'Price', description: t("What you pay for something - the number on the price tag.") }, 
            { title: 'Value', description: t("What you actually get in return - utility, joy, frequency of use, longevity.") }, 
      ...
      actionSteps={[
        ...
        { number: '02', text: 'Create a physical or digital t("Want List") starting today' }, 
