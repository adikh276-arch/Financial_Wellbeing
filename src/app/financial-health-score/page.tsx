...
const QUESTIONS = [
  ...
  { id: 'knowsCreditScore', text: t('Do you know your credit score?'), options:[{ label: t('Yes, and it\'s good (750+)t('), score: 10 }, { label: t(')Yes, but it needs workt('), score: 5 }, { label: t(')No'), score: 0 }], category: t('Debt & Obligations') },
