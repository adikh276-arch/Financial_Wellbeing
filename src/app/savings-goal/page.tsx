        ...
        {step === -1 && !completed && (
          <div style={{ textAlign: 'center', padding: 'var(--space-12) var(--space-4)', animation: 'fadeIn 0.5s ease' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-3)', maxWidth: 380, margin: '0 auto var(--space-10)', textAlign: 'left' }}>
              {[
                { icon: <Gem size={16} color={ACCENT} />, title: 'Crystal Clear'), desc: 'Define exactly what you want and why') },
                { icon: <Calendar size={16} color={ACCENT} />, title: 'Time Bound'), desc: 'Pick a deadline that motivates you') },
                { icon: <Wallet size={16} color={ACCENT} />, title: 'Budget Fit'), desc: 'Calculate the exact push needed') },
                { icon: <Rocket size={16} color={ACCENT} />, title: 'Success Path'), desc: 'Choose a strategy that ensures success') },
              ].map((item, i) => (
                <div key={i} style={{
          ...
          <div style={{ animation: 'fadeInUp 0.4s ease both', paddingTop: 'var(--space-8)' }}>
            <div style={{ textAlign: 'center', marginBottom: 'var(--space-6)' }}>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: 'var(--text-sm)', marginTop: 6 }}>
                {'Choose a category and name your goal.'}
              </p>
            </div>
            ...
            <div style={{
              ...
              <input
                ...
                placeholder={'e.g. Dream Vacation in Bali'}
                style={{
            ...
            >
              {'Set My Target'} <ArrowRight size={18} />
            </button>
          </div>
        )}
        ...
        {step === 1 && !completed && (
          <div style={{ animation: 'slideInRight 0.35s ease both', paddingTop: 'var(--space-8)' }}>
            ...
            <button
              ...
              style={{ width: '100%', background: ACCENT, color: 'white', border: 'none', boxShadow: `0 8px 20px ${ACCENT}40` }}
            >
              {'Choose Strategy'} <ArrowRight size={18} />
            </button>
          </div>
        )}
          ...
          <div style={{ animation: 'fadeInUp 0.5s ease both', paddingTop: 'var(--space-8)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
              ...
              <button className="btn btn-secondary btn-lg" onClick={handleReset} style={{ width: '100%' }}>
                <RotateCcw size={16} /> {'Set Another Goal')}
              </button>
            </div>
          </div>
        )}
