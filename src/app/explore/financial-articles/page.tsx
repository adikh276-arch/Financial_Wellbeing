...
const ARTICLES = [
  ...
  { id: 4, title: t('Choosing Between Long-term Savings Vehicles'), author: 'Financial Wellbeing Team', readTime: "14 min", category: t('Tax'), preview: "Comparison of various instruments for long-horizon capital growth and tax optimization.", content: t('In-depth analysis of pension funds vs ETFs...'), icon: Shield, color: '#FDCB6E' },
