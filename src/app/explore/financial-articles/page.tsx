...
const ARTICLES = [
  { id: 1, title: t('The Complete Beginner\'s Guide to Mutual Funds'), author: 'Financial Wellbeing Team', readTime: "12 min", category: t('Investing'), preview: "Mutual funds are a simple way to start investing professionally. Learn about systematic plans and risk-adjusted returns.", content: "Detailed content about mutual funds...", icon: TrendingUp, color: '#2563EB' },
  { id: 2, title: t('How the 52-Week Money Challenge Can Transform Your Savings'), author: 'Financial Wellbeing Team', readTime: "8 min", category: t('Savings'), preview: "Gamify your saving habit by increasing your weekly goal. By week 52, you will have a substantial emergency buffer.", content: "Step by step guide for the 52-week challenge...", icon: Zap, color: '#00B894' },
  { id: 3, title: t('Understanding Your Credit Score: A Deep Dive'), author: 'Financial Wellbeing Team', readTime: "10 min", category: t('Credit'), preview: "Learn how your score is calculated and the specific behaviors that can boost it or hurt it significantly.", content: "Comprehensive report on credit scoring algorithms...", icon: Activity, color: '#0984e3' },
  { id: 4, title: t('Choosing Between Long-term Savings Vehicles'), author: 'Financial Wellbeing Team', readTime: "14 min", category: t('Tax'), preview: "Comparison of various instruments for long-horizon capital growth and tax optimization.", content: "In-depth analysis of pension funds vs ETFs...", icon: Shield, color: '#FDCB6E' },
  { id: 5, title: t('The Hidden Cost of Lifestyle Inflation'), author: 'Financial Wellbeing Team', readTime: "7 min", category: t('Behavior'), preview: "Why raises often don't lead to more wealth. Learn how to maintain your savings rate during income shifts.", content: "Psychological strategies to combat lifestyle creep...", icon: Heart, color: '#fd79a8' },
  { id: 6, title: t('Emergency Fund Math: How Much is Actually Enough?'), author: 'Financial Wellbeing Team', readTime: "6 min", category: t('Savings'), preview: "A framework to calculate your custom safety net based on volatility and fixed obligations.", content: "Detailed mathematical models for emergency funds...", icon: Target, color: '#e84393' },
];
