...
const QUESTIONS = [
  ...
  { id: 'rate', text: t('What percentage of your income do you save?'), options:[t('0-5%'), t('5-10%'), t('10-20%'), t('Over 20%')] },
  { id: 'consistency', text: t('How consistent are your savings?'), options:[t('Rarely save'), t('Occasional/Inconsistent'), t('Mostly consistent'), t('Automated & Guaranteed')] },
